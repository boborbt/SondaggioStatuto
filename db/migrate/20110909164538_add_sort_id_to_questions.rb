...
class AddSortIdToQuestions < ActiveRecord::Migration
  def self.up
    add_column :questions, :sort_id, :integer
    add_index :questions, :sort_id
  end

  def self.down
    remove_index :questions, :sort_id
    remove_column :questions, :sort_id
  end
end